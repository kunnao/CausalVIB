import numpy as np
from semi_parametric_estimation.helpers import truncate_by_g
tlevel = 0.01
...
class Evaluator(object):
    ...
    def relative_pehe(self, ypred1, ypred0):
        peherel = np.abs((self.true_ite - (ypred1 - ypred0))/self.true_ite)
        return peherel
        # return np.mean(peherel)
    ...
    def calc_stats(self, ypred1, ypred0):
        ...
        peherel = self.relative_pehe(ypred1, ypred0)
        return ite, ate, pehe, peherel
